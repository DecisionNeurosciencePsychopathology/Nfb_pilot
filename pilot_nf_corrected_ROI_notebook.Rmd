...
<<<<<<< HEAD
# check correlations
rois <-  subset(df, select=c(161:167))

data(rois)
library(reshape2)
qplot(x=Var1, y=Var2, data=melt(cor(rois)), fill=value, geom="tile")
=======
...
## Behavioral results, mood ratings
...
setwd("~/Google Drive/skinner/Pecina_k/results/")
